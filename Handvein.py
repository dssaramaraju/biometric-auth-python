...
with open('dot_hand.pickle', 'rb') as f:
    dot1 = pickle.load(f)
  

import pickle
with open('labels_hand.pickle', 'rb') as f:
...
data_1 = os.listdir('Dataset/Hand Vein/Authorized')
  
data_2 = os.listdir('Dataset/Hand Vein/Non')
